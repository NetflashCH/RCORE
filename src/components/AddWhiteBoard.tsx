...
const AddWhiteBoard = () => {
  ...
  return (
    <section className="  w-[1090.2px]">
      <form className="grid gap-[1.5rem]" onSubmit={submitHandler}>
        ...
        <div className="flex items-center justify-between">
          <div className="input">
            ...
            <button
              ...
              className="p-2 bg-red-600 w-[150px] rounded-lg text-[1.2rem]"
            >
              {`${readOnly}`}
            </button>
          </div>
        ...
        <div className="flex items-center justify-between  pr-[1.8rem]">
          <button
            type="submit"
            className="px-6 py-3 text-md w-[150px]  font-bold text-black bg-[#F29E20] rounded-lg"
          >
            Submit
          </button>
          <button
            ...
            className="px-6 py-3 text-md w-[150px]  font-bold text-black bg-[#f22020] rounded-lg"
          >
            cancel
          </button>
        </div>
