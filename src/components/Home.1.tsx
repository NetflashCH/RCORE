...
export const Home = () => {
  ...
  const [reducer, setreducer] = useState<boolean>(false);
  ...
  return (
    <>
      {!store.active ? (
            ...
            {store.data.map((item, index) => {
              return (
                  ...
                  >
                    <div className="flex center justify-between gap-[1rem] h-[24px]">
                      ...
                      <div className="flex items-center gap-[1rem] w-max h-max">
                        <div className="cursor-pointer relative  tootip  ">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                ...
                gap-[.5rem] bg-[#F29E20] w-[90px] h-[32px] rounded-[.5rem]"
                    ...
                    <ul className="bg-[#282B43] rounded-[.5rem] grid gap-[1rem] py-[1rem] px-[1.5rem] tootip2 relative">
        ...
        <Edit item={store.cardData as dataTypes} />
      )}
    </>
  );
};
